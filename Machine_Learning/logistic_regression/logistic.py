...
for g in genre_list:
    for n in range(100):
        rad = "E:/BaiduNetdiskDownload/trainset/" + g + "." + str(n).zfill(5) + ".fft" + ".npy"
...
sample_rate, test = wavfile.read("E:/BaiduNetdiskDownload/trainset/sample/heibao-wudizirong-remix.wav")
